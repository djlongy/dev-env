...
# ../../vendor/fonts/meslolgs-nf exists the four faces are copied out of
...
VENDOR_FONTS=""
VENDOR_CANDIDATE="${SCRIPT_DIR}/../../vendor/fonts/meslolgs-nf"
...
case "$OS" in
    ...
    *)
        ...
        echo "       Windows clients: ../../windows/install-nerd-font.ps1" >&2
        exit 1
        ;;
esac
...
install_from_download() {
    ...
    if ! command -v curl &>/dev/null; then
        ...
        echo "       vendor/fonts/meslolgs-nf and needs no network." >&2
        exit 1
    fi
